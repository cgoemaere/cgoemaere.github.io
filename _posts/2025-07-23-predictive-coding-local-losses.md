...
- **Do other losses lead to other models?** Yes! For example, the loss $\mathcal{L}_i  = \frac{1}{2} \|\mathbf{s_i}\|^2 - \rho(\mathbf{s_i})^T \cdot \mathbf{\hat{s}_i}$ corresponds to the Continuous Hopfield network from [Bengio](https://arxiv.org/pdf/1510.02777).
